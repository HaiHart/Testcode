...
|Main scenario| Customer choose from web menu\ then check for quantity in cart<br/> The order is finished proceed to payment<br/>  Create order in txt file after payment
